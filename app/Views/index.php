		...
		<ul class="main_menu">
			...
			<li><a href="#">Minimum Stock ONT</a>
				<ul>
					...
					<li><a href="project-image.html">Report Delivery ONT</a></li>
				</ul>
			</li>
			<li><a href="#">Minimum Stock STB</a>
				<ul>
					<li><a href="blog.html">Rekap Minimum Stock STB</a></li>
					<li><a href="blog-single.html">Report Delivery STB</a></li>
				</ul>
			</li>
			<li><a href="#">Minimum Stock AP</a>
				<ul>
					<li><a href="blog.html">Rekap Minimum Stock Access Point</a></li>
					<li><a href="blog-single.html">Report Delivery Access Point</a></li>
				</ul>
			</li>
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="pull-left logo">
						<a href="index.html">
							<img src="images/logominitok.png" alt="Minitok" width="100" height="auto">
						</a>
					</div> <!-- /.logo -->
						...
						<nav class="main-nav visible-md visible-lg">
							<ul class="sf-menu">
								...
								<li><a href="#">Input Data</a>
									<ul>
										<li><a href="blog.html">Upload File Stock</a></li>
										<li><a href="blog-single.html">Update File Delivery</a></li>
										<li><a href="blog-single.html">Update File Minimum Stock</a></li>
									</ul>
								</li>
							</ul> <!-- /.sf-menu -->
						</nav> <!-- /.main-nav -->
